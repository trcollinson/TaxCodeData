CREATE TABLE IF NOT EXISTS report (npi varchar(10) NOT NULL, lastname varchar(35), firstname varchar(20), suffix varchar(5),
    ...
    tax_category varchar(30), tax_main varchar(10), tax_secondary varchar(10), tax_other varchar(10));
