CREATE TABLE IF NOT EXISTS report (npi varchar(10), lastname varchar(35), firstname varchar(20), suffix varchar(5),
    ...
    phone_bus varchar(20), phone_home varchar(20), phone_cell varchar(20), phone_unchecked varchar(20),
